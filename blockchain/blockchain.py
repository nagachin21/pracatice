...
class BlockChain(object):
    ...
    def create_transaction(self, sender_blockchain_address,
        ...
        is_transated = self.add_transaction(
    ...
    def add_transaction(self, sender_blockchain_address,
        ...
        if self.verify_transaction_signature(sender_public_key, signature, transaction):
            ...
            if self.calcurate_total_amount(sender_blockchain_address) < float(value):
                logging.error({'action': 'add_transaction', 'error': 'no_value'})
                return False
    ...
    def calcurate_total_amount(self, blockchain_address):
        total_amount = 0.0

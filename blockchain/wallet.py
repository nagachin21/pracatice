...
class Wallet(object):
    ...
    def generate_blockchain_address(self):
        ...
        sha256_bpk_digest = sha256_bpk.digest()
        sha256_2_npbk = hashlib.sha256(sha256_bpk_digest)
        sha256_2_npbk_digest = sha256_2_npbk.digest()
        sha256_hex = codecs.encode(sha256_2_npbk_digest, 'hex')
        # 6
...
if __name__ == '__main__':
    ...
    print('A', block_chain.calcurate_total_amount(wallet_A.blockchain_address))
    print('B', block_chain.calcurate_total_amount(wallet_B.blockchain_address))